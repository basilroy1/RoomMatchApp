...
=======
      return;
>>>>>>> 235e0fd23e545b4e4b319f6aca1467140eae956e
   }
 ...
 <div >
  ...
  <div className="form-row">
    <div className="form-group col-md-6" >
      ...
      {this.state.name ? <span style={{color: "#66cc00"}}>That's Good!</span> :<span style={{color: "#ff8080"}}>.</span>}
    </div>
    <div className="form-group col-md-6">
      ...
      {this.state.age ? <span style={{color: "#66cc00"}}>That's Good!</span> :<span style={{color: "#ff8080"}}>.</span>}
  ...
  <div className="form-group">
    ...
    {this.state.location ? <span style={{color: "#66cc00"}}>That's Good!</span> :<span style={{color: "ff8080"}}>.</span>}
    </div>
         {/* <div className="form-group col-md-6">
        ...
        <div className="form-group">
          ...
          {this.state.year ? <span style={{color: "#66cc00"}}>That's Good!</span> :<span style={{color: "#ff8080"}}>.</span>}
        </div>
